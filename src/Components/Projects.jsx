...
function Projects() {
  return (
    <section id="projects" className="p-8 bg-gradient-to-r from-black to-black text-gray-100 flex flex-col items-center gap-6">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-8 p-4 w-full md:w-3/4 border-b-2 rounded-lg animate-slide-up">
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-4">
          ...
          <ul className="list-disc pl-5 text-lg space-y-2 animate-fade-in">
            ...
            <li>Its uses React Hooks for StateManagement and side effects and localstorage for persistent data storage.</li>
          </ul>
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-8 p-4 w-full md:w-3/4 border-b-2  rounded-lg animate-slide-up">
        <div className="w-full md:w-1/2 transform transition-transform duration-500 hover:scale-105">
          <img src={image} alt="Foody zone" className="w-full h-auto rounded-lg shadow-md animate-zoom-in" />
        </div>
        <div className="w-full md:w-1/2 flex flex-col gap-4">
          <h3 className="text-2xl font-bold animate-fade-in">Foody Store</h3>
          <p className="text-lg animate-fade-in">Developed a feature foody zone platform using React and Figma CSS.</p>
          <ul className="list-disc pl-5 text-lg space-y-2 animate-fade-in">
            <li>Foody Zone is a responsive web app designed to offer users a seamless food browsing experience.</li>
            <li>Using React.js for dynamic component-based architecture, CSS for styling, and Figma for wireframing and prototyping.</li>
            <li>this app provides a user-friendly interface with a modern design.</li>
            <li>UI incorporates a simple search functionality and category-based food filters like Breakfast, Lunch, and Dinner.</li>
